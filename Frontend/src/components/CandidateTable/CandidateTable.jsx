...
const CandidateTable = () => {
    ...
    const handleDownload = async (id, fullName, skills, experience) => {
        try {
            const response = await fetch(`http://localhost:8080/api/candidate/download/${id}`, {
                method: "GET"
            });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/api/candidate/delete/${id}`, {
                method: "DELETE",
            });
    ...
    const handleUpdateSave = async () => {
        try {
            const response = await fetch(`http://localhost:8080/api/candidate/update/${selectedId}`, {
                method: "PUT",
                headers: {
