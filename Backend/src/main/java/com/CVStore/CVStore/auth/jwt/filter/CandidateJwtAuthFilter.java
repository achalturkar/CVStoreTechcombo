package com.CVStore.CVStore.auth.jwt.filter;
...
public class CandidateJwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = candidateUserDetailsService.loadUserByUsername(userEmail);
